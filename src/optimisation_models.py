...
Purpose:
- Inventory optimisation using EOQ and safety stock analysis
- Logistics route optimisation using vehicle routing algorithms
- Operational cost and emissions comparison

This module supports data-driven operational decision making.
"""
...
class OptimisationModels:
    ...
    def logistics_optimization(self, vehicle_count=3, max_points=200):
        ...
        if solution:
            ...
            # Save optimisation outputs for downstream analytics
...
if __name__ == "__main__":
    optimiser = OptimisationModels(db_path="supply_chain.db", visual_dir="visuals")
    optimiser.inventory_optimization()
    optimiser.logistics_optimization(vehicle_count=5, max_points=200) 
    optimiser.close()
    print("\nOPTIMISATION WORKFLOW COMPLETE: Inventory and Logistics Optimisation completed.")
