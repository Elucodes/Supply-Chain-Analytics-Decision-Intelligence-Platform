...
if __name__ == "__main__":
    p2 = Phase2Predictive(db_path="supply_chain.db", visual_dir="visuals")
    p2.demand_forecasting(horizon=30)
    p2.monte_carlo_demand(periods=30, sims=500)
    p2.predict_disruptions()
    p2.close()
    print("\nPHASE 2 COMPLETE: Forecasting, Monte Carlo, and Risk Prediction done.")
